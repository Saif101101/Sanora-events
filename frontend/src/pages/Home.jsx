...
import { mockServices, mockGalleryImages, mockTestimonials } from '../data/mockData';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-6" style={{ background: 'linear-gradient(to bottom, #f5f3f0 0%, #ffffff 100%)' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-bold mb-6 leading-tight" style={{ fontFamily: 'sans-serif' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={() => scrollToSection('book')} className="bg-[#5a4d4d] hover:bg-[#4a3d3d] text-white px-8 py-6 text-lg rounded-md transition-all shadow-md hover:shadow-lg">
              Plan Your Event
            </Button>
            <Button onClick={() => scrollToSection('services')} variant="outline" className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-6 text-lg rounded-md transition-all">
              View Services
            </Button>
          </div>
        </div>
      ...
      <section id="about" className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-5xl font-bold mb-6" style={{ fontFamily: 'sans-serif' }}>About Us</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            At Sanora Events, we believe every celebration deserves to be extraordinary. With years of experience in creating magical moments, 
            our dedicated team transforms your vision into reality with meticulous attention to detail, creative expertise, and seamless execution.
          </p>
        </div>
      </section>

      {/* Services Section */}
      <section id="services" className="py-20 px-6" style={{ background: '#fafaf8' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mockServices.map((service, index) => (
              <Card key={index} className="overflow-hidden border-0 shadow-md hover:shadow-xl transition-all duration-300 group">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockGalleryImages.map((image, index) => (
              <div key={index} className="relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group" style={{ height: index % 3 === 0 ? '400px' : '320px' }}>
      ...
      <section id="testimonials" className="py-20 px-6" style={{ background: '#fafaf8' }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-4" style={{ fontFamily: 'sans-serif' }}>What Our Clients Say</h2>
            <p className="text-lg text-gray-600">Real stories from celebrations we've brought to life</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="border-0 shadow-xl">
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full bg-[#5a4d4d] hover:bg-[#4a3d3d] text-white py-6 text-lg rounded-md transition-all shadow-md hover:shadow-lg">
                  Send Inquiry
                </Button>
              </form>
            </CardContent>
